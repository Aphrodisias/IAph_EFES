...
<xsl:stylesheet exclude-result-prefixes="#all"
  ...
  <!-- This XSLT transforms a set of EpiDoc documents into a Solr
       index document representing an index of non-verbal designs in those
       documents. -->
  ...
  <xsl:template match="/">
    <add>
      <xsl:for-each-group select="//tei:rs[@type='design'][@ref][ancestor::tei:div/@type='edition']" group-by="@ref">
        <doc>
